<template>
  <div ref="wrapRef" class="simple-search-wrap" :style="wrapScaleStyle">
    ...
    <SimpleSearchDrawer
      ...
      :open="drawerOpen"
      :catalog="catalog"
      :quick-keys="quickKeys"
      :custom-engines="customEngines"
      :custom-form="customForm"
      :editing-custom-key="editingCustomKey"
      :custom-form-error="customFormError"
      @close="closeDrawer"
      @toggle-engine="toggleEngineSwitch"
      @submit-custom="submitCustomForm"
      @cancel-edit="cancelEditCustom"
      @start-edit="startEditCustomEngine"
      @remove-engine="removeCustomEngine"
      @clear-form-error="clearFormError"
      @custom-url-input="onCustomUrlTemplateInput"
      @custom-url-blur="onCustomUrlTemplateBlur"
    />
  </div>
</template>
